...
public class HotelController {
    ...
    public ResponseEntity AddHotel(@RequestBody @Valid @ApiParam(value = "酒店所有",required = true) HotelsRequest hotels, BindingResult bindingResult){
    ...
    public ResponseEntity getHotels(HttpServletRequest request){
        ...
        ResponseServer hotels = hotelService.getHotels();
